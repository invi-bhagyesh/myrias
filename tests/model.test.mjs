...
test('sample graph is valid and unscored',()=>{const w=M.exampleWorkspace();assert.equal(w.nodes.length,6);assert.ok(w.edges.every(e=>e.confidence===null));assert.deepEqual(M.validateWorkspace(w),w);});
